...
=================================-->
        ...
        START FEATURE AREA
 ======================================-->
        <Feature /><!-- end feature-area -->

        <!--======================================
        START CATEGORY AREA
======================================-->
        <Category /><!-- end category-area -->
        <!--======================================
        START COURSE AREA
======================================-->
        <Courses />
            ...
            <div class="container">
                <div class="cta-content-wrap text-center">
                    <div class="section-heading">
                        <h5 class="ribbon ribbon-lg mb-2">
            ...
            <div class="container-fluid">
                <div class="testimonial-carousel owl-action-styled">
                    <div class="card card-item">
                        <div class="card-body">
                            <div
                                class="media media-card align-items-center pb-3"
                            >
                            ...
                            <!-- end media -->
                            <p class="card-text">
                                My children and I LOVE Aduca! The courses are
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                ...
                                amazing selection of courses here. The
                                instructors are so knowledgable while being fun
                                and interesting. Lorem ipsum dolor sit amet,
                                consectetur adipisicing elit. Ad blanditiis
                                consectetur
                            </p>
                        </div>
                        <!-- end card-body -->
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <!-- end media -->
                            <p class="card-text">
                                I really recommend this site to all my friends
                                and anyone who’s willing to learn real skills.
                                This platform gives you the opportunity to learn
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                ...
                                learning and my dream of becoming a web
                                developer.
                            </p>
                        </div>
                        <!-- end card-body -->
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <!-- end media -->
                            <p class="card-text">
                                I came across this site when I had no funds to
                                pay for a college education. This site has
                                literally been a lifesaver as I can now earn
                                from freelance working using the skills I
                                learned from here.
                            </p>
                        </div>
                        <!-- end card-body -->
                        ...
                        <div class="about-content pb-5">
                            <div class="section-heading">
                                ...
                                <h2 class="section__title">
                                    Benefits of Learning With Aduca
                                </h2>
                                <span class="section-divider"></span>
                                <p class="section__desc">
                                    Simply dummy text of the printing and
                                    typesetting industry. Lorem Ipsum has been
                                    the industry’s when an unknown printerit to
                                    make a type specimen book Pellentesque
                                    tellus arcu
                                </p>
                            </div>
                            <!-- end section-heading -->
                            <div class="row pt-4 pb-3">
                                <div class="col-lg-4 responsive-column-half">
                                    <div class="info-icon-box mb-3">
                                        <div
                                            class="icon-element icon-element-md shadow-sm"
                                        >
                                            <svg
                                        ...
                                        <h4
                                            class="fs-20 font-weight-semi-bold pt-3"
                                        >
                                            130,000 Courses
                                        </h4>
                                    </div>
                    ...
                    <div class="col-lg-5 ml-auto">
                        <div class="generic-img-box">
                            <img
                                ...
                                data-src="images/img13.jpg"
                                alt="About image"
                                class="img__item img__item-1 lazy"
                            />
                            <img
                                src="images/img-loading.png"
                                data-src="images/img14.jpg"
                                alt="About image"
                                ...
                                <form method="post">
                                    ...
                                    <div class="input-box">
                                        ...
                                        <div class="form-group">
                                            ...
                                            />
                                            <span
                                                class="la la-envelope input-icon"
                                            ></span>
                                        </div>
                                    </div>
                                    <!-- end input-box -->
                    ...
                    <div class="col-lg-6 ml-auto">
                        <div class="register-content">
                            <div class="section-heading">
                                ...
                                <span class="section-divider"></span>
                                <p class="section__desc">
                                    Education is the process of acquiring the
                                    body of knowledge and skills that people are
                                    expected have in your society. A education
                                    develops a critical thought process in
                                    addition to learning. Bimply dummy text of
                                    the printing and typesetting istryrem Ipsum
                                    has been the industry’s standard dummy text
                                    ever since the 1500s, when an unknown
                                    printer Lorem ipsum dolor sit amet,
                                    consectetur adipisicing elit. Aliquam
                                    aliquid architecto aspernatur, facilis
                                    perspiciatis rerum saepe vel vitae? Alias
                                    culpa dicta facere maiores quam quas, quis
            ...
            <div class="container">
                ...
                <div class="client-logo-carousel pt-4">
                    <a href="#" class="client-logo-item"
                        ><img src="images/sponsor-img.png" alt="brand image"
                    /></a>
                    <a href="#" class="client-logo-item"
                        ><img src="images/sponsor-img2.png" alt="brand image"
                    /></a>
                    <a href="#" class="client-logo-item"
                        ><img src="images/sponsor-img3.png" alt="brand image"
                    /></a>
                    <a href="#" class="client-logo-item"
                        ><img src="images/sponsor-img4.png" alt="brand image"
                    /></a>
                    <a href="#" class="client-logo-item"
                        ><img src="images/sponsor-img5.png" alt="brand image"
                    /></a>
                </div>
...
================================= -->
        <section class="blog-area section--padding bg-gray overflow-hidden">
            <div class="container">
                ...
                <!-- end section-heading -->
                <div
                    class="blog-post-carousel owl-action-styled half-shape mt-30px"
                >
                    <div class="card card-item">
                    ...
                    <div class="card card-item">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">
                                <a href="blog-single.html"
                                    >Ultimate Photoshop Training: From
                                    Beginner</a
                                >
                            </h5>
                            <ul
                    ...
                    <div class="col-lg-4 responsive-column-half">
                        <div class="card card-item hover-s text-center">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    Teach what you love. Aduca gives you the
                                ...
                                <div class="btn-box mt-20px">
                                    <a
                                        ...
                                        ><i class="la la-user mr-1"></i>Start
                                        Teaching</a
                                    >
                                </div>
                                <!-- end btn-box -->
                    ...
                    <div class="col-lg-4 responsive-column-half">
                        <div class="card card-item hover-s text-center">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    Learn what you love! transform your life
                                    through education
                                </p>
                                <div class="btn-box mt-20px">
                                    <a
                    ...
                    <div class="col-lg-4 responsive-column-half">
                        <div class="card card-item hover-s text-center">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    Get unlimited access to 5,000+ of Aduca's
                                ...
                                <div class="btn-box mt-20px">
                                    <a
                                        href="for-business.html"
                                        class="btn theme-btn theme-btn-sm theme-btn-white lh-30"
                                        ><i class="la la-briefcase mr-1"></i>Get
                                        aduca for business</a
                                    >
                                </div>
                                <!-- end btn-box -->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5 ml-auto">
                        <form method="post" class="subscriber-form">
                            ...
                            <p class="fs-14 mt-1">
                                <i class="la la-lock mr-1"></i>Your information
                                is safe with us! unsubscribe anytime.
                            </p>
                        </form>
                    </div>
                    <!-- end col-lg-6 -->
                ...
                <div class="row">
                    <div class="col-lg-3 responsive-column-half">
                        <div class="footer-item">
                            ...
                            <h3 class="fs-20 font-weight-semi-bold pt-4 pb-2">
                                We are on
                            </h3>
                    ...
                    <div class="col-lg-3 responsive-column-half">
                        <div class="footer-item">
                            ...
                            <span
                                class="section-divider section--divider"
                            ></span>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            ...
                            >
                                ...
                                <div
                                    class="select-container select-container-sm"
                                >
...
export default {
    ...
    components: {
        ...
        Courses,
        Course,
        Funfact, // Register the Header component
    },
    // other options...
};
</script>
